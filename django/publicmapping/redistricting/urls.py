...
urlpatterns = patterns('publicmapping.redistricting.views',
    ...
    (r'^plan/(?P<planid>\d*)/district/(?P<district_id>\d*)/comments/$', 'district_comment'),
    (r'^plan/(?P<planid>\d*)/district/(?P<district_id>\d*)/comment/(?P<comment_id>\d*)/version/(?P<version>\d*)/$', 'delete_district_comment'),
    (r'^plan/(?P<planid>\d*)/district/(?P<district_id>\d*)/tags/(?P<tag_type>label|type)/$', 'district_tags'),
    ...
    (r'^plan/(?P<planid>\d*)/splits/(?P<otherplanid>\d*)/$', 'get_splits'),
    (r'^getplans/$', 'getplans'),
