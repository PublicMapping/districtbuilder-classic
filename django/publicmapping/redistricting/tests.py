...
class PurgeTestCase(BaseTestCase):
    ...
    def test_purge_versions(self):
        ...
        self.assertEqual(
            13, newversion,
            'Adding items to sequential positions in history resulted in the wrong number of versions. (e:17,a:%d)'
            % newversion)
        ...
        self.assertEqual(
            5, previous,
            'The previous version is incorrect, since edits were performed off of 8,7,6,5 versions, with the last edit being off of version 5. (e:5, a:%d)'
            % previous)
...
class CalculatorTestCase(BaseTestCase):
    ...
    def test_contiguity_singlepoint(self):
        ...
        self.assertEqual(
            ...
            'District is contiguous at 1 point, but single-point contiguity is false.'
        )
        ...
        self.assertEqual(
            ...
            'District is contiguous at 1 point, and single-point contiguity is true.'
        )
        ...
        self.assertEqual(
            1, cntcalc.result['value'],
            'District is contiguous at 1 point twice, and single-point contiguity is true.'
        )
        ...
        self.assertEqual(
            1, cntcalc.result['value'],
            'District is contiguous at 1 point thrice, and single-point contiguity is true.'
        )
        ...
        self.assertEqual(
            0, cntcalc.result['value'],
            'District is contiguous at 1 point thrice, but has a disjoint geometry.'
        )
    ...
    def test_contiguity_overrides(self):
        ...
        self.assertEqual(
            0, cntcalc.result['value'],
            'Calculator needs allow_single_point on to be considered contiguous'
        )
        cntcalc.arg_dict['allow_single_point'] = (
            'literal',
            '1',
...
class ScoreRenderTestCase(BaseTestCase):
    ...
    def test_panelrender_plan(self):
        ...
        for panel in panels:
            ...
            template.write(
                '{% for planscore in planscores %}{{planscore.plan.name}}:{{ planscore.score|safe }}{% endfor %}'
            )
            template.close()
    ...
    def test_panelrender_district(self):
        ...
        for panel in panels:
            ...
            template = open(tplfile, 'w')
            template.write(
                '{% for dscore in districtscores %}{{dscore.district.long_label }}:{% for score in dscore.scores %}{{ score.score|safe }}{% endfor %}{% endfor %}'
            )
            template.close()
    ...
    def test_scoredisplay_with_overrides(self):
        ...
        self.assertEqual(
            ...
            'Didn\'t get expected result when overriding district\'s display (e:"%s", a:"%s")'
            % (expected, district_result))
        ...
        self.assertEqual(
            ...
            'Didn\'t get expected result when overriding plan\'s display (e: "%s", a:"%s")'
            % (expected, plan_result))
    ...
    def test_splitcounter_display(self):
        ...
        self.assertEqual(
            ...
            "Didn't get expected result when rendering SplitCounter:\ne:%s\na:%s"
            % (expected_result, plan_result))
    ...
    def test_filter_functions(self):
        ...
        for feat in test_layer:
            ...
            if len(geolevels) == 2:
                ...
                self.fail(
                    "Incorrect number of geolevels returned - should never get here"
                )
...
class ConfigTestCase(TestCase):
    ...
    def test_constructor_missing_schema(self):
        try:
            ...
            self.fail(
                'Expected failure when passing nonexistant filenames to constructor.'
            )
        except:
            pass
    ...
    def test_validation(self):
        ...
        self.assertTrue(
            is_valid,
            'Configuration schema and data should be valid and should validate successfully.'
        )
