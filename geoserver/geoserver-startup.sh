...
DISTRICT_BUILDER_DB_HOST=${DISTRICT_BUILDER_DB_HOST:-postgres}
DISTRICT_BUILDER_DB_PASSWORD=${DISTRICT_BUILDER_DB_PASSWORD:-district_builder}
DISTRICT_BUILDER_DB_USER=${DISTRICT_BUILDER_DB_USER:-district_builder}
DISTRICT_BUILDER_DB_DATABASE=${DISTRICT_BUILDER_DB_DATABASE:-district_builder}
DISTRICT_BUILDER_DB_PORT=${DISTRICT_BUILDER_DB_PORT:-5432}
